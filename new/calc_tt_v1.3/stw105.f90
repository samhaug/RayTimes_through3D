!stw105.f90
!
! Routine modified by Carlos Chaves from model_1dref.f90 (SPECFEM 3D GLOBE-7.0)
!--------------------------------------------------------------------------------------------------
!
...
!
  ...
  subroutine model_1dref_broadcast()
...
!-------------------------------------------------------------------------------------------------
!
subroutine model_1dref(x,vv,vh,iregion_code,phase)
...
! shear wave speed vsh
    ...
    double precision :: x,vpv,vph,vsv,vsh,vv,vh
